   ...
   const {selectedChatType,selectedChatData,userInfo} = useAppStore()
    ...
    return(
        <div className="h-[10vh] bg-[#1c1d25] flex justify-center items-center px-8 mb-5 gap-6">
            ...
            <button onClick={handleSentMessage} className="bg-[#8417ff] rounded-md flex items-center justify-center p-5   focus:border-none hover:bg-[#741bda] focus:bg-[#741bda] focus:outline-none focus:text-white duration-300 transition-all">
